...
#
# Options:
#   --url URL          Screen address (required)
...
URL=""; ROTATE=90; REBOOT="03:30"; TZ_NAME="America/Chicago"; FORCE_1080=1; CONNECT=0
while [[ $# -gt 0 ]]; do
  case "$1" in
    --url) URL="$2"; shift 2 ;;
...
[[ -n "$URL" ]] || { echo "Missing --url. Example: --url \"https://your-site.netlify.app/?site=landmark-center\""; exit 1; }
...
apt-get install -y wlr-randr x11-xserver-utils curl >/dev/null || true
